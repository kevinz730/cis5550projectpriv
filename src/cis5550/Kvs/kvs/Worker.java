package cis5550.Kvs.kvs;

import static cis5550.Webserver.webserver.Server.get;
import static cis5550.Webserver.webserver.Server.port;
import static cis5550.Webserver.webserver.Server.put;
...
public class Worker extends cis5550.Kvs.generic.Worker {
...
//        		Persistent
        		...
        		String rowEncoded = cis5550.Kvs.tools.KeyEncoder.encode(row);
...
//        	return "KVS Coordinator" + workerTable(); 
        ...
        put("/rename/:table", (req,res) -> {  
        	...
        	if (((table.length() >= 3 && table.substring(0,3).equals("pt-")) && (newName.length() < 3 || !newName.substring(0,3).equals("pt-"))) 
    			|| ((table.length() < 3 || !table.substring(0,3).equals("pt-")) && (newName.length() >= 3 && newName.substring(0,3).equals("pt-")))) {
